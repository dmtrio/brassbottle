...
grep -qF -- '. "$SCRIPT_DIR/src/git_notices.sh"' up.sh \
    ...
    && grep -qF -- 'git_orgs_host_notice "$REPOS" "$GIT_HOST_TOKENS" "$GIT_ORG_ROUTED_HOSTS"' up.sh \
