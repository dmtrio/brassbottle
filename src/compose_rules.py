...
The workspace contract (/workspace/CONTRACT.md, installed by up.sh) is appended
...
DEFAULT_WORKSPACE = "/workspace/CONTRACT.md"
...
WORKSPACE_NOTICE = (
    ...
    "copied from /workspace/CONTRACT.md so every harness reads it. Edit "
    "docs/workspace.CONTRACT.md in brassbottle, not this file. -->"
)
