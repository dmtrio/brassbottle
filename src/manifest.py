...
COMPOSE_VOLUME_NAMES = {
    "workspace", "claude-auth", "codex-auth", "gemini-state",
    "cursor-state", "cursor-auth", "gh-auth",
}
COMPOSE_MOUNT_PATHS = {
    "/workspace", "/artifacts", "/artifacts/browser", "/agent-rules",
    "/home/coder/.agent-keys", "/home/coder/.claude", "/home/coder/.codex",
...
def plugin_compose_overlay(volumes):
    ...
    lines = [
        ...
        "# so `foo` is really `dev-agent-<container>_foo` — per container, like the",
        "# auth volumes, and removed by `./down.sh <container> --purge`.",
        "services:",
        "  dev-agent:",
        "    environment:",
